...
Route::get('/reports/bsale-documents/download/{paymentId}/{documentType}', [ReportController::class, 'downloadPaymentDocument'])->name('reports.bsale-documents.download-document')->where('documentType', 'bsale_invoice|payment_receipt|contract');
