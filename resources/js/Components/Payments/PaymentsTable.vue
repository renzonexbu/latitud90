    ...
    <div class="bg-white rounded-[20px] overflow-hidden">
        ...
        <div class="flex flex-col gap-0">
            ...
            <div class="flex flex-col h-[574px] overflow-hidden">
                ...
                >   
                    <!-- ID -->
                    <div class="text-[#5b5b5b] font-nexa-bold text-[14px] leading-[18px] text-center w-[80px]">
                        #{{ payment.id }}
                    </div>
                    ...
                    <!-- Acciones -->
                    <div class="flex gap-2 items-center justify-center w-[80px]">
                        <!-- View Details Button -->
                        <button 
                            @click.stop="$emit('show-payment-details', payment)"
                            class="w-[18px] h-[19px] hover:opacity-75 transition-opacity"
                        >
                            <svg width="18" height="19" viewBox="0 0 24 24" fill="none" stroke="#C7C7C7" stroke-width="2">
