<template>
    ...
    >
        ...
        >
            <g opacity="0.3">
                <path
                    d="M20.625 15H9.375M9.375 15L13.75 19.375M9.375 15L13.75 10.625"
                    stroke="#434343"
                    stroke-width="1.875"
        ...
        <span
            class="text-[#434343] font-outfit text-xl font-normal leading-normal"
        >
            {{ buttonText }}
        </span>
    </button>
