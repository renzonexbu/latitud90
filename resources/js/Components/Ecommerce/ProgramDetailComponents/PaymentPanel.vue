    ...
    <div :class="containerClass">
        <div class="flex flex-col gap-[16px] md:gap-[24px] w-full md:max-w-none mx-auto">
            ...
            <div class="flex flex-col gap-[12px] md:gap-[18px]">
                ...
                <!-- Mensaje de suscripciones deshabilitadas -->
                <div v-if="program.subscriptions_globally_disabled" class="bg-amber-50 border border-amber-200 rounded-md p-4">
                    <div class="flex">
                        ...
                        <div class="ml-3">
                            <h3 class="text-sm font-medium text-amber-800">
                                Suscripcion PAT no disponible
                            </h3>
                            <div class="mt-2 text-sm text-amber-700">
                                <p>{{ program.subscriptions_disabled_message || 'El metodo de pago por suscripcion no esta disponible temporalmente. Por favor, selecciona otra forma de pago.' }}</p>
                            </div>
                        </div>
                    </div>
                </div>
