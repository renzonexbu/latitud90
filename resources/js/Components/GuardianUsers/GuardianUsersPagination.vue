<template>
    <div class="flex flex-row items-center justify-end gap-4 relative">
        <div class="flex flex-row gap-[6.996px] items-center justify-start flex-shrink-0 relative">
            <div class="w-[180px] h-[14px] flex-shrink-0 text-verde-oscuro font-nexa text-[14.582px] font-normal leading-[18.749px]">
...
<script>
export default {
    name: "GuardianUsersPagination",
    props: {
        currentPage: { type: Number, default: 1 },
        totalUsers: { type: Number, required: true },
        usersPerPage: { type: Number, default: 15 },
    },
    computed: {
        totalPages() {
