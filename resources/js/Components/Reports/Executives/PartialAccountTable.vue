            ...
            <table class="w-full min-w-full">
                <thead class="bg-[#1c4f4a]">
                    <tr>
                        ...
                        <th class="px-3 py-3 text-left text-xs font-medium text-white uppercase tracking-wider w-28">Cuotas Pagadas</th>
                        <th class="px-3 py-3 text-left text-xs font-medium text-white uppercase tracking-wider w-28">Cuotas Vencidas</th>
                        <th class="px-3 py-3 text-left text-xs font-medium text-white uppercase tracking-wider w-28">Forma de Pago</th>
