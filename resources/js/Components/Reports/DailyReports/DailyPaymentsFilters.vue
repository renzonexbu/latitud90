<template>
    <div class="flex flex-col gap-[18px] items-start justify-start relative">
        ...
        <div class="flex flex-wrap gap-[15px] items-center justify-start w-full relative">
            ...
            <div class="relative w-[320px]" data-program-search>
                <div class="relative">
                    <input
...
export default {
    ...
    data() {
        return {
            filters: {
                ...
                paymentMethod: this.initialFilters.paymentMethod || "",
    ...
    mounted() {
        ...
        // Si hay un programId inicial, seleccionar el programa
