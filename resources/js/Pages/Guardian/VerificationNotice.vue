<template>
  <Head title="Verifica tu Email - Pagador" />
  ...
  <div class="min-h-screen bg-gray-50 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
    <div class="verification-card">
      ...
      <div class="verification-icon-wrapper">
        <div class="verification-icon-bg">
      ...
      <div class="email-info-box">
        <p class="email-info-label">Debes verificar tu email antes de continuar:</p>
      ...
      <div class="warning-box">
        ...
        <div class="warning-content">
          <p class="warning-title">El enlace expira en 24 horas</p>
      ...
      <div class="logout-section">
        <p class="logout-label">Quieres usar otra cuenta?</p>
        <Link
...
const resendVerification = () => {
  form.post(route('guardian.verification.resend'), {
    preserveScroll: true,
    onSuccess: () => {
