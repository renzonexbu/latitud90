                    ...
                    <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                        <div class="p-6 text-gray-900">
                            ...
                            <p class="text-sm text-gray-600 mb-4">
                                Generar archivo ZIP con auxiliares y movimientos contables para importar en Softland
                            </p>
                            ...
                            >
                                ...
                                {{ isGenerating ? 'Generando...' : 'Descargar Ambos Archivos' }}
                            </button>
                        </div>
                    </div>
...
const generateTemplate = async () => {
    try {
        ...
        const url = `${route('admin.reports.export.softland-zip')}?${params.toString()}`;
