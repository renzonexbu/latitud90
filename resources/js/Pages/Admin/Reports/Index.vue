                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
                            ...
                            >
                                <div class="flex items-center mb-3">
                                    ...
                                    <h3 class="text-lg font-semibold text-blue-800">Estado de Cuenta Parcial</h3>
                                </div>
                                <p class="text-sm text-blue-600">Informe de estado de cuenta que L90 reenviará</p>
                            </Link>
                            ...
                            >
                                <div class="flex items-center mb-3">
                                    ...
                                    <h3 class="text-lg font-semibold text-green-800">Cronograma de Recuperación</h3>
                                </div>
                                <p class="text-sm text-green-600">Cuotas pactadas, vencimientos y cobranzas</p>
                            </Link>
                            ...
                            >
                                <div class="flex items-center mb-3">
                                    ...
                                    <h3 class="text-lg font-semibold text-yellow-800">Pagos Diarios</h3>
                                </div>
                                <p class="text-sm text-yellow-600">Reporte detallado de pagos por día</p>
                            </Link>
                            ...
                            >
                                <div class="flex items-center mb-3">
                                    ...
                                    <h3 class="text-lg font-semibold text-purple-800">Consolidado de Pagos</h3>
                                </div>
                                <p class="text-sm text-purple-600">Resumen consolidado de todos los pagos</p>
                            </Link>
                        </div>
                    </div>
                </div>
                            ...
                            >
                                ...
                                >
                                    <path
                                        ...
                                        stroke-linejoin="round"
                                        stroke-width="2"
                                        d="M12 10v6m0 0l-3-3m3 3l3-3M3 7v10a2 2 0 002 2h14a2 2 0 002-2V9a2 2 0 00-2-2H5a2 2 0 00-2-2z"
                                    ></path>
                                </svg>
                                Exportar CSV
                            </button>
