<template>
    <AdminLayout>
        <Head title="Crear Programa - Curso" />
            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                ...
                <div class="mb-8">
                    <h1 class="text-[#007e93] font-nexa-bold text-[32px] leading-[38px] font-bold">
                        Crear Programa - Curso
                    </h1>
                    <p class="text-[#5b5b5b] font-nexa-regular text-[14px] leading-[20px] mt-2">
                        Selecciona una plantilla de programa y completa los detalles administrativos
                    </p>
                </div>
                                            ...
                                            <div v-if="travelersOpen" class="accordion-content">
                                                ...
                                                <div class="students-upload-section">
                                                    ...
                                                    <div class="students-upload-field">
                                                        <div class="field-wrapper">
                                                            <div class="field-label">
                                                                Adjunta la lista de participantes *
                                                            </div>
                                                            ...
                                                            <!-- Botón previsualizar cambios -->
                                                            <button
                                                                v-if="form.studentsFile"
                                                                type="button"
                                                                @click="previewImport"
                                                            ...
                                                            >
                                                                ...
                                                                {{ isPreviewLoading ? 'Analizando archivo...' : 'Previsualizar cambios antes de aplicar' }}
                                                            </button>
...
const maxInstallmentChoices = computed(() => {
    ...
    if (form.value.final_payment_date) {
        ...
        // +1 porque la primera cuota se paga el día de suscripción (día 0)
...
// Preview de importación de participantes (dry-run, sin course creado aún)
const showPreviewModal = ref(false);
const previewData = ref(null);
const isPreviewLoading = ref(false);

const previewImport = async () => {
    if (!form.studentsFile) return;
    ...
    try {
        ...
        const response = await axios.post(
            route('admin.courses.participants.preview-import-new'),
            fd,
