        ...
        <div class="py-6 lg:py-12">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="flex items-center justify-between mb-6">
                    <div>
                        <h1 class="text-3xl font-nexa-bold text-verde-oscuro">Editar Institución</h1>
                        <p class="text-gray-600 mt-2 font-nexa-regular">Modificar los datos de la institución</p>
                    </div>
                    <Link
