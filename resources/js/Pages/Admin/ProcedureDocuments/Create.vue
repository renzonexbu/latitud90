<template>
    <AdminLayout>
        <Head title="Agregar Documento Procedimiento" />

        <div class="py-12">
            <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
                <!-- Header -->
                <div class="mb-6">
                    <h1 class="text-3xl font-nexa-bold text-gray-900">Agregar Documento Procedimiento</h1>
                    <p class="mt-2 text-sm text-gray-600">Sube documentos en formato PDF, DOC o DOCX</p>
                </div>
...
const submit = () => {
    form.post(route('admin.procedure-documents.store'));
};
</script>
