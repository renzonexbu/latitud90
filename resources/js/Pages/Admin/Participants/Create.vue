                            ...
                            <div class="space-y-4">
                                ...
                                <div>
                                    ...
                                    <select 
                                        ...
                                        :class="[
                                            ...
                                            errors.document_type ? 'border-red-500' : 'border-[#5b5b5b]'
                                        ]"
                                    >
                                    ...
                                    <span v-if="errors.document_type" class="text-red-500 text-xs mt-1">{{ errors.document_type }}</span>
                                </div>
                                ...
                                <div>
                                    ...
                                    <input 
                                        ...
                                        :class="[
                                            ...
                                            isRutDocument && rutValidation.isValid === true ? 'border-green-500' : ''
                                        ]"
                                    />
                                    <span v-if="errors.document_number" class="text-red-500 text-xs mt-1">{{ errors.document_number }}</span>
                                    <span v-if="isRutDocument && rutValidation.message" :class="[
                                        'text-xs mt-1',
                                ...
                                <div class="grid grid-cols-2 gap-3">
                                    <div>
                                        ...
                                        <input 
                                            ...
                                            :class="[
                                                'w-full h-[46px] bg-white rounded-lg border px-4 py-2 text-left font-nexa-bold text-[12px] leading-[18px] font-bold outline-none placeholder-[#c7c7c7]',
                                                errors.nationality ? 'border-red-500' : 'border-[#5b5b5b]'
                                            ]"
                                        />
                                        <span v-if="errors.nationality" class="text-red-500 text-xs mt-1">{{ errors.nationality }}</span>
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <select 
                                            ...
                                            :class="[
                                                'w-full h-[46px] bg-white rounded-lg border px-4 py-2 text-left font-nexa-bold text-[12px] leading-[18px] font-bold outline-none appearance-none',
                                                errors.gender ? 'border-red-500' : 'border-[#5b5b5b]'
                                            ]"
                                        >
                                ...
                                <div>
                                    ...
                                    <input 
                                        ...
                                        :class="[
                                            'w-full h-[46px] bg-white rounded-lg border px-4 py-2 text-left font-nexa-bold text-[12px] leading-[18px] font-bold outline-none placeholder-[#c7c7c7]',
                                            errors.dietary_restrictions ? 'border-red-500' : 'border-[#5b5b5b]'
                                        ]"
                                    />
                                    <span v-if="errors.dietary_restrictions" class="text-red-500 text-xs mt-1">{{ errors.dietary_restrictions }}</span>
                                </div>
                                ...
                                <div>
                                    ...
                                    <input 
                                        ...
                                        :class="[
                                            'w-full h-[46px] bg-white rounded-lg border px-4 py-2 text-left font-nexa-bold text-[12px] leading-[18px] font-bold outline-none placeholder-[#c7c7c7]',
                                            errors.intolerances ? 'border-red-500' : 'border-[#5b5b5b]'
                                        ]"
                                    />
                                    <span v-if="errors.intolerances" class="text-red-500 text-xs mt-1">{{ errors.intolerances }}</span>
                                </div>
                                ...
                                <div>
                                    ...
                                    <input 
                                        ...
                                        :class="[
                                            'w-full h-[46px] bg-white rounded-lg border px-4 py-2 text-left font-nexa-bold text-[12px] leading-[18px] font-bold outline-none placeholder-[#c7c7c7]',
                                            errors.allergies ? 'border-red-500' : 'border-[#5b5b5b]'
                                        ]"
                                    />
                                    <span v-if="errors.allergies" class="text-red-500 text-xs mt-1">{{ errors.allergies }}</span>
                                </div>
                            ...
                            <div class="space-y-4">
                                ...
                                <div>
                                    ...
                                    <input 
                                        ...
                                        :class="[
                                            'w-full h-[46px] bg-white rounded-lg border px-4 py-2 text-left font-nexa-bold text-[12px] leading-[18px] font-bold outline-none placeholder-[#c7c7c7]',
                                            errors['emergency_contacts.0.name'] ? 'border-red-500' : 'border-[#5b5b5b]'
                                        ]"
                                    />
                                    <span v-if="errors['emergency_contacts.0.name']" class="text-red-500 text-xs mt-1">{{ errors['emergency_contacts.0.name'] }}</span>
                                </div>
                            ...
                            <div class="space-y-4">
                                ...
                                <div>
                                    ...
                                    <select 
                                        ...
                                        :class="[
                                            'w-full h-[46px] bg-white rounded-lg border px-4 py-2 text-left font-nexa-bold text-[12px] leading-[18px] font-bold outline-none appearance-none',
                                            errors.program_id ? 'border-red-500' : 'border-[#5b5b5b]'
                                        ]"
                                    >
                                    ...
                                    <span v-if="errors.program_id" class="text-red-500 text-xs mt-1">{{ errors.program_id }}</span>
                                </div>
                            </div>
                        </div>
                    </div>
...
export default {
    ...
    computed: {
        isRutDocument() {
            const selectedDocType = this.documentTypes.find(dt => dt.id == this.form.document_type);
    ...
    methods: {
                ...
                const emergencyContacts = [
                    {
                        ...
                        document_number: this.form.emergency_contact_document_number,
                    }
                ];
        ...
        formatEmergencyRut() {
            ...
            let rut = this.form.emergency_contact_document_number.replace(/[^0-9kK]/g, '').toUpperCase();
            if (rut.length > 1) {
                const body = rut.slice(0, -1);
                const dv = rut.slice(-1);
                let formattedBody = '';
        ...
        validateEmergencyRut() {
            const rut = (this.form.emergency_contact_document_number || '').replace(/[\.\-]/g, '');
            if (!rut) return;
        ...
        onDocumentInput() {
            ...
            if (selectedDocType && selectedDocType.name.toLowerCase() === 'rut') {
                this.formatRut();
            } else if (selectedDocType && selectedDocType.name.toLowerCase() === 'pasaporte') {
                // Convertir a mayúsculas para pasaporte
                this.form.document_number = this.form.document_number.toUpperCase();
            }
        },
