  ...
  <AdminLayout>
    ...
    <div class="py-12">
      <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        ...
        <div class="bg-white rounded-[20px] min-h-[166px] relative overflow-hidden mb-6">
          <div class="px-8 py-3 flex flex-col gap-3 items-start justify-start w-full">
            <div class="flex flex-col gap-[10px] items-start justify-start self-stretch flex-shrink-0 relative">
              <div class="flex flex-col gap-[22px] items-start justify-start self-stretch flex-shrink-0 relative">
                <div class="flex flex-col gap-[12px] items-start justify-start self-stretch flex-shrink-0 relative">
                  <div class="flex flex-col items-start justify-between self-stretch flex-shrink-0 h-[46px] relative">
                    <div class="flex flex-col gap-[20px] items-start justify-start self-stretch flex-shrink-0 relative">
                                             <div class="flex flex-row items-start justify-between self-stretch flex-shrink-0 relative">
                         <div class="flex flex-col gap-[6px] items-start justify-center flex-shrink-0 flex-1 relative">
                           <div class="text-turquesa text-left font-nexa-bold text-[24px] leading-[28px] font-bold relative self-stretch">
              ...
              <div class="flex flex-col gap-[25px] items-start justify-start self-stretch flex-shrink-0 relative">
                    ...
                    <div class="flex-shrink-0 w-[17.888px] h-[17.888px] relative overflow-hidden aspect-square">
                      ...
                      <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18" fill="none">
                        <g clip-path="url(#clip0_806_11208)">
                          <path d="M8.94651 2.07661V5.47536M4.80924 9.83367V17.1959M8.94396 14.3862V17.2496M13.0787 9.83367V17.1959M9.02445 3.44889C10.168 3.53449 11.1966 3.53449 12.3414 3.44889C12.4449 2.50337 12.4449 1.64729 12.3414 0.703056C11.2374 0.618513 10.1285 0.618513 9.02445 0.703056C8.9206 1.61539 8.9206 2.53656 9.02445 3.44889ZM4.78113 10.2822C3.82539 10.3039 3.22869 10.3333 2.24996 10.369C1.53315 10.3959 0.926235 10.9134 0.829128 11.6199C0.574861 13.4841 0.574861 13.9991 0.829128 15.8633C0.926235 16.5698 1.53188 17.0873 2.24996 17.1141C7.07976 17.2943 10.8069 17.2943 15.638 17.1141C16.3548 17.086 16.9617 16.5698 17.0575 15.8633C17.3131 13.9991 17.3131 13.4841 17.0575 11.6199C16.9617 10.9134 16.3548 10.3959 15.6392 10.369C14.6592 10.3333 14.0676 10.3039 13.1119 10.2822C13.0917 9.88071 13.0675 9.47949 13.0391 9.07854C12.8116 4.28068 5.08267 4.26791 4.85524 9.07087C4.82628 9.48571 4.80072 9.88947 4.78113 10.2822Z" stroke="#007E93" stroke-width="1.27772" stroke-linecap="round" stroke-linejoin="round"/>
                          <path d="M8.9437 10.9784C9.91861 10.9784 10.4667 10.4328 10.4667 9.4643C10.4667 8.49578 9.91733 7.9502 8.9437 7.9502C7.9688 7.9502 7.42065 8.49578 7.42065 9.4643C7.42065 10.4328 7.9688 10.9784 8.9437 10.9784Z" stroke="#007E93" stroke-width="1.27772" stroke-linecap="round" stroke-linejoin="round"/>
                        </g>
                        <defs>
                          <clipPath id="clip0_806_11208">
                            <rect width="17.8881" height="17.8881" fill="white"/>
                          </clipPath>
                        </defs>
                      </svg>
                    </div>
                    <div class="flex flex-row gap-[5.98px] items-center justify-start flex-shrink-0 relative">
                      <div class="flex flex-row gap-[2.39px] items-center justify-start flex-shrink-0 relative">
                        <div class="text-turquesa text-left font-nexa-bold text-[14px] leading-[18px] font-bold relative">
                          {{ participant.course?.institution?.name || 'Institución no asignada' }}
                        </div>
                        <div class="text-turquesa text-left font-nexa-bold text-[14px] leading-[15.54px] font-bold relative">|</div>
                        <div class="text-turquesa text-left font-nexa-bold text-[14px] leading-[18px] font-bold relative">
                          {{ participant.course?.grade || 'N/A' }}
                        </div>
                  ...
                  <div class="flex flex-row gap-[25px] items-start justify-start flex-wrap self-stretch flex-shrink-0 relative">
                    ...
                    <div class="flex flex-row gap-[5px] items-center justify-start flex-shrink-0 relative">
                      <div class="flex-shrink-0 w-[18px] h-[18px] relative overflow-hidden flex items-center justify-center">
                        <!-- Mail Icon -->
                        <svg xmlns="http://www.w3.org/2000/svg" width="19" height="19" viewBox="0 0 19 19" fill="none">
                          <rect width="18" height="18" transform="translate(0.930664 0.888184)" fill="white"/>
                          <path d="M3.18066 6.02588C3.18066 5.62805 3.3387 5.24652 3.62 4.96522C3.90131 4.68391 4.28284 4.52588 4.68066 4.52588H15.1807C15.5785 4.52588 15.96 4.68391 16.2413 4.96522C16.5226 5.24652 16.6807 5.62805 16.6807 6.02588V13.5259C16.6807 13.9237 16.5226 14.3052 16.2413 14.5865C15.96 14.8678 15.5785 15.0259 15.1807 15.0259H4.68066C4.28284 15.0259 3.90131 14.8678 3.62 14.5865C3.3387 14.3052 3.18066 13.9237 3.18066 13.5259V6.02588Z" stroke="#007E93" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                          <path d="M3.18066 6.02588L9.93066 10.5259L16.6807 6.02588" stroke="#007E93" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                        </svg>
                      </div>
                      <div class="text-turquesa text-left font-nexa-bold text-[14px] leading-[18px] font-bold underline relative w-[115px] h-[10px]">
                        {{ participant.email || 'Mail@gmail.com' }}
                  </div>
                    </div>
                  </div>
                </div>
        ...
        <div class="bg-white rounded-[20px] p-6">
          <h3 class="text-xl font-bold text-gray-900 mb-6">Programas del Participante</h3>
