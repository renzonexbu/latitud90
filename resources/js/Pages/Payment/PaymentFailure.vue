  ...
  <div class="min-h-screen bg-gray-50">
    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div class="text-center mb-8">
        ...
        <h1 class="text-3xl font-bold text-gray-900 mb-2">{{ failureTitle }}</h1>
      ...
      <div class="bg-white rounded-xl shadow-lg p-8 mb-8">
        ...
        <div v-if="paymentData" class="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div>
            <h3 class="text-lg font-medium text-gray-900 border-b pb-2 mb-4">Detalles del Pago</h3>
            <div class="space-y-3">
              <div>
              ...
              <div>
                ...
                <p class="text-gray-900 font-bold text-xl text-red-600">
        ...
        <div v-else class="text-center py-8">
          <p class="text-gray-500">No se pudo obtener la información del pago.</p>
        </div>
      </div>

      <!-- Información de Contacto -->
      <div v-if="showContactInfo" class="bg-blue-50 border border-blue-200 rounded-lg p-6 mb-8">
        <div class="flex items-start">
          ...
          <div class="ml-3">
            <h3 class="text-lg font-medium text-blue-800">¿Necesitas Ayuda?</h3>
            <div class="mt-2 text-blue-700">
              <p class="text-sm">
                Si se te descontó dinero de tu cuenta pero el pago no se procesó correctamente, 
                contacta a nuestro equipo de atención al cliente para verificar el estado de tu transacción.
              </p>
              <div class="mt-4 space-y-2">
                <p class="text-sm">
                  <strong>Email:</strong> 
                  <a href="mailto:contacto@latitud90.cl" class="underline hover:text-blue-800">
                    contacto@latitud90.cl
                  </a>
                </p>
                <p class="text-sm">
                  <strong>WhatsApp:</strong> 
                  <a href="https://wa.me/56912345678" target="_blank" class="underline hover:text-blue-800">
                    +56 9 1234 5678
                  </a>
                </p>
              </div>
...
const showContactInfo = computed(() => {
  return ['pending_validation', 'max_attempts', 'error'].includes(errorStatus)
})
...
const searchMoreTrips = () => {
  const programsUrl = props.rut ? `/programs?rut=${encodeURIComponent(props.rut)}` : '/programs'
