    ...
    public function run(): void
    {
        $paymentFormContent = [
            ...
            [
                ...
                'key' => 'subtitle',
                'type' => 'textarea',
                'value' => 'Selecciona la forma de pago que mejor se adapte a ti, pago con tarjeta de crédito o débito, o pago automático con PAT. Para cualquier consulta, no dudes en escribirnos por WhatsApp',
                'default_value' => 'Selecciona la forma de pago que mejor se adapte a ti, pago con tarjeta de crédito o débito, o pago automático con PAT. Para cualquier consulta, no dudes en escribirnos por WhatsApp',
                'use_default' => false,
